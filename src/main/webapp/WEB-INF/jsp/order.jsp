...
<header class="header">
    <nav class="header-nav">
        <a href="/home" class="logo">
            ...
            <span>LMS PRO - ORDER MANAGEMENT</span>
        </a>
        ...
        <div class="table-container">
            <table class="table">
                    ...
                    <tr class="fade-in">
                        ...
                        <td>
                            <c:choose>
                                ...
                                <c:otherwise><span style="color:rgb(var(--muted-foreground))">Not set</span></c:otherwise>
                            </c:choose>
                        </td>
                        <td>
                            <c:choose>
                ...
                <c:if test="${empty orders}">
                    <tr>
                        <td colspan="7" style="text-align:center;padding:3rem;color:rgb(var(--muted-foreground))">
