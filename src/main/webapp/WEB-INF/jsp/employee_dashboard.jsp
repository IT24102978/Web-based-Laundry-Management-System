...
<head>
    ...
    <title>LMS PRO – Employee Portal</title>
...
<header class="bg-white/80 dark:bg-slate-800 backdrop-blur border-b border-slate-200 dark:border-slate-700 shadow-sm sticky top-0 z-50">
    <nav class="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        <a href="${pageContext.request.contextPath}/employee-dashboard" class="flex items-center gap-2 font-bold text-xl text-white dark:text-white">
            🧑‍💼 LMS PRO – Employee Portal
        </a>
...
<main class="flex-1 max-w-6xl mx-auto px-6 py-12 w-full fade-in">
    <h1 class="text-3xl font-bold dark:text-blue-900 mb-2">Dashboard Overview</h1>
    <p class="text-slate-500 dark:text-slate-400 mb-6">Manage operations efficiently with LMS PRO.</p>
...
<footer class="bg-slate-800 text-white py-4 mt-12 shadow-inner">
    <div class="max-w-6xl mx-auto text-center text-sm dark: opacity-90">
